 ...
 *              globalThis.PFS.state.SID             (modules/state.js)
...
function _tpSID() {
  ...
  return (pfs && pfs.state && pfs.state.SID) || "";
}
...
// Expose the panel on the PFS namespace.
const pfs = globalThis.PFS || {};
pfs.tempPrompt = Object.freeze({ tpSave, tpToggle, tpClear, tpUpdateCount, tpOpenWithText });
globalThis.PFS = pfs;
